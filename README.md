...
> **⚠️ Beta Release**: This is a beta version of Gophertainer. While feature-complete, it is still undergoing testing and refinement. **Do NOT use in production environments yet.** Many commands can fail - please report errors in the [issues tab](https://github.com/your-username/gophertainer/issues).
...
```bash
# Clone and build
git clone https://github.com/your-username/gophertainer.git
cd gophertainer
